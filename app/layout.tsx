...
export const metadata: Metadata = {
	...
	description: "Nachtaras Community Garden für Streams, Turniere, Challenges, Minecraft und gemeinsame Projekte.",
	icons: { icon: [{ url: "/favicon.svg", type: "image/svg+xml" }, { url: "/favicon.png", type: "image/png" }] },
	openGraph: {
